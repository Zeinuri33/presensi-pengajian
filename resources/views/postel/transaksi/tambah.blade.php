...
<div class="modal fade text-start" id="kt_modal_transaksi" tabindex="-1" aria-hidden="true">
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y px-15 px-lg-15 pt-0 pb-15">
                <!--begin::Form-->
                <form class="form" method="POST" enctype="multipart/form-data" action="/postel-transaksi">
                    @csrf
                    <!--begin::Heading-->
                    <div class="mb-13 text-center">
                        <!--begin::Title-->
                        <h1 class="mb-3">Tambah Transaksi</h1>
                        <div class="text-muted fw-semibold fs-5">{{ $kepalakamar->nama }} - {{ $kepalakamar->jabatan === 'Wakil Kamar' ? 'Wakil Kepala Kamar' : $kepalakamar->jabatan }} Asrama {{ $kepalakamar->asrama->kode }}</div>
                        <!--end::Title-->
                    </div>
                    <input type="hidden" name="kepalakamar_id" value="{{ $kepalakamar->id }}">
                    <!--end::Heading-->
                    <div class="row">
                        <!-- Durasi -->
                    ...
                    <div class="fv-row mb-6">
                        ...
                        <div class="input-group">
                            <span class="input-group-text">Rp.</span>
                            <input type="number" name="bayar" id="bayar" class="form-control" placeholder="Jumlah Bayar" min="500" required>
                        </div>
                    </div>
                    ...
                    <div class="fv-row mb-6">
                        ...
                        <div class="input-group">
                            <span class="input-group-text">Rp.</span>
                            <input  type="number"  name="kembali"  id="kembali"  class="form-control"  placeholder="Kembalian" min="0"  readonly>
                        </div>
                    </div>
                    ...
                    <!--begin::Label-->
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input type="text" name="petugas" class="form-control" placeholder="Petugas/Kasir">
                        <!--end::Input-->
