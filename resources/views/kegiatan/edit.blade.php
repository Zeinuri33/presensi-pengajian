    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y px-15 px-lg-15 pt-0 pb-15">
                <!--begin::Form-->
                <form class="form" method="POST" enctype="multipart/form-data" action="{{ route('kegiatan.update', $item->id) }}">
                    @csrf
                    @method('PUT')
                    <!--begin::Heading-->
                    <div class="mb-13 text-center">
                        ...
                        <div class="text-muted fw-semibold fs-5">Edit Kegiatan</div>
                        <!--end::Title-->
                    </div>
                    <!--end::Heading-->
                    <!--begin::Input group-->
                    ...
                    <!--begin::Label-->
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input type="text" name="kegiatan" placeholder="Nama Kegiatan" value="{{ $item->kegiatan }}" class="form-control" required>
                        <!--end::Input-->
                    </div>
                    <!--end::Input group-->
                    <!--begin::Input group-->
                    ...
                    <!--begin::Label-->
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input type="text" name="tempat" placeholder="Tempat Kegiatan" value="{{ $item->tempat }}" class="form-control" required>
                        <!--end::Input-->
                    </div>
                    <!--end::Input group-->
                    <!--begin::Input group-->
                    ...
                    <!--begin::Label-->
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input type="date" name="tanggal" placeholder="Tempat Kegiatan" value="{{ $item->tanggal }}" class="form-control" required>
                        <!--end::Input-->
                    </div>
                    <!--end::Input group-->
                    <!--begin::Input group-->
                    ...
                    <!--begin::Label-->
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input type="time" name="waktu" placeholder="Waktu Kegiatan" value="{{ $item->waktu }}" class="form-control" required>
                        <!--end::Input-->
                    </div>
                    <!--end::Input group-->
                    <!--begin::Input group-->
                    ...
                    <!--begin::Label-->
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input type="time" name="batasabsen" placeholder="Batas Absen Kegiatan" value="{{ $item->batasabsen }}" class="form-control" required>
                        <!--end::Input-->
                    </div>
                    <!--end::Input group-->
                    <!--begin::Actions-->
