...
<div class="card card-flush">
    ...
    <div class="card-header align-items-center py-5 gap-2 gap-md-5" style="background-image: url('{{ asset('assets/media/ibrahimy/akses.png') }}'); background-size: cover; background-position: center; background-color: rgba(0,0,0,0.3); background-blend-mode: darken; color: white;">
        ...
        <div class="card-title">
            ...
            <div class="d-flex align-items-center position-relative my-1">
                ...
                <input type="text" data-kt-ecommerce-product-filter="search" class="form-control w-250px ps-12" placeholder="Cari Wakil Kepala Kamar" />
            </div>
            <!--end::Search-->
        </div>
        <!--end::Card title-->
        ...
        <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
            ...
            <form method="GET" action="{{ route('wakilkamar.cetak') }}" target="_blank" class="row">
                {{-- SELECT WILAYAH --}}
                <div class="col-md-4">
    ...
    @include('asrama.wakilkamar.tambah')
    <!--end::Card header-->
    <!--begin::Card body-->
        ...
        <table class="table align-middle table-striped fs-6 gy-4" id="kt_ecommerce_products_table">
            <thead class="fw-bold fs-5 bg-primary">
                <tr class="text-start text-white fw-bold fs-7 text-uppercase gs-0">
                    <th class="min-w-200px rounded-start ps-4">Wakil Kepala Kamar</th>
                    <th></th>
                    <th></th>
                    <th></th>
                    <th></th>
                ...
                <tr>
                    <td class="d-flex align-items-center ps-4">
                        ...
                        <div class="symbol symbol-50px overflow-hidden me-3">
                            <div class="symbol-label">
                                @if($item->foto == null )
                                <img src="assets/media/avatars/blank.png" alt="{{ $item->foto }}" class="w-100" />
                                @else
                    ...
                    <td class="text-end pe-4">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                            ...
                            <!--end::Menu item-->
                            <!--begin::Menu item-->
                            @can('wakil kamar-hapus')
                            <div class="menu-item px-3">
                                <a href="{{ asset('wakilkamar/'.$item->id.'/hapus') }}" class="delete-button menu-link px-3">Hapus</a>
                            </div>
                            @endcan
                            <!--end::Menu item-->
                        </div>
