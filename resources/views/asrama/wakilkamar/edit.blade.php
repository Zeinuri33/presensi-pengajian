...
<div class="modal fade" id="kt_modal_edit{{ $item->id }}" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-dialog modal-dialog-centered mw-600px">
        ...
        <div class="modal-body scroll-y px-15 px-lg-15 pt-0 pb-15">
            <!--begin:Form-->
            <form id="kt_modal_update_details" class="form" method="POST" enctype="multipart/form-data" action="{{ route('kepalakamar.update', $item->id) }}">
                @csrf
                @method('PUT')
                <!--begin::Heading-->
                <div class="mb-13 text-center">
                    ...
                    <div class="text-muted fw-semibold fs-5">{{ $item->jabatan }} asrama {{ $item->asrama->asrama }}.</div>
                    <!--end::Title-->
                </div>
                <!--end::Heading-->
                <!--begin::Input group-->
                <div class="text-center fv-row mb-7">
                    ...
                    <div class="image-input image-input-outline image-input-placeholder" data-kt-image-input="true">
                        ...
                        @else
                        <div class="image-input-wrapper w-125px h-125px" style="background-image: url({{ asset('/storage/kepalakamar/' . $item->foto) }});"></div>
                        @endif
                ...
                <div class="fv-row mb-7">
                    ...
                    <!--end::Label-->
                    <!--begin::Input-->
                    <input type="text" name="nis" class="form-control" placeholder="Nama Wakil Kepala Kamar" value="{{ $item->nis }}" maxlength="10" required/>
                    <!--end::Input-->
                </div>
                <!--end::Input group-->
                <!--begin::Input group-->
                <div class="fv-row mb-7">
                    ...
                    <!--end::Label-->
                    <!--begin::Input-->
                    <input type="text" name="nama" class="form-control" placeholder="Nama Wakil Kepala Kamar" value="{{ $item->nama }}" required/>
                    <!--end::Input-->
                </div>
                <!--end::Input group-->
                    ...
                    <select class="form-select" name="asrama_id" data-control="select2" data-hide-search="true" data-placeholder="Pilih Asrama">
                        ...
                        @foreach ($asrama as $kamar)
                            <option value="{{ $kamar->id }}"
                                {{ old('asrama_id', $item->asrama_id) == $kamar->id ? 'selected' : '' }}>
