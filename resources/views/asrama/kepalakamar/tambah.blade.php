        ...
        <div class="modal-body scroll-y px-15 px-lg-15 pt-0 pb-15">
            ...
            <form id="kt_modal_update_details" class="form" method="POST" enctype="multipart/form-data" action="/kepalakamar">
                ...
                <div class="mb-13 text-center">
                    <!--begin::Title-->
                    <h1 class="mb-3">Tambah Kepala Kamar</h1>
                ...
                <div class="text-center fv-row mb-7">
                    <!--begin::Label-->
                    <label class="d-block fw-semibold fs-6 mb-5">Foto Kepala Kamar</label>
                    <!--end::Label-->
                ...
                <div class="fv-row mb-7">
                    <!--begin::Label-->
                    <label class="required fw-semibold fs-6 mb-2">NIS Kepala Kamar</label>
                    <!--end::Label-->
                    <!--begin::Input-->
                    <input type="text" name="nis" class="form-control" placeholder="NIS Kepala Kamar" maxlength="10" required   />
                    <!--end::Input-->
                </div>
                <!--end::Input group-->
                <!--begin::Input group-->
                <div class="fv-row mb-7">
                    <!--begin::Label-->
                    <label class="required fw-semibold fs-6 mb-2">Nama Kepala Kamar</label>
                    <!--end::Label-->
                    <!--begin::Input-->
                    <input type="text" name="nama" class="form-control" placeholder="Nama Kepala Kamar" required/>
                    <!--end::Input-->
                </div>
                <!--end::Input group-->
                ...
                <input type="hidden" name="jabatan" value="Kepala Kamar">
