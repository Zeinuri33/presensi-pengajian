    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y px-15 px-lg-15 pt-0 pb-15">
                <!--begin::Form-->
                <form class="form" method="POST" enctype="multipart/form-data" action="/asrama">
                    @csrf
                    <!--begin::Heading-->
                    <div class="mb-13 text-center">
                        <!--begin::Title-->
                        <h1 class="mb-3">Tambah Asrama</h1>
                    ...
                    <!--begin::Label-->
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input type="number" name="nomor" min="1" value="1" placeholder="Nomor Asrama" class="form-control" required>
                        <!--end::Input-->
                    </div>
                    <!--end::Input group-->
                    <!--begin::Actions-->
