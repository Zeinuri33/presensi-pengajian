...
<div class="card card-flush">
    ...
    @include('arsip.suratkeluar.tambah')
    <!--end::Card header-->
    <!--begin::Card body-->
    <div class="card-body pt-5">
        ...
        <table class="table align-middle table-striped fs-6 gy-4" id="kt_ecommerce_products_table">
            ...
            <tbody class="fw-semibold text-gray-600">
                ...
                <tr>
                    ...
                    <td class="text-end pe-2">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                            ...
                            <!--end::Menu item-->
                            <!--begin::Menu item-->
                            @can('surat keluar-hapus')
                            <div class="menu-item px-3">
                                <a href="{{ asset('suratkeluar/'.$item->id.'/hapus') }}" class="menu-link px-3 delete-button">Hapus</a>
                            </div>
                            @endcan
                            <!--end::Menu item-->
                        </div>
                ...
                @include('arsip.suratkeluar.edit')
                @endforeach
            </tbody>
        </table>
        <!--end::Table-->
