    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y px-15 px-lg-15 pt-0 pb-15">
                <!--begin::Form-->
                <form class="form" method="POST" enctype="multipart/form-data" action="{{ route('suratkeluar.update', $item->id) }}">
                    @csrf
                    @method('PUT')
                    <!--begin::Heading-->
                    <div class="mb-13 text-center">
                        ...
                        <div class="text-muted fw-semibold fs-5">Edit Surat Keluar</div>
                        <!--end::Title-->
                    </div>
                    <!--end::Heading-->
                    ...
                    <div class="fw-row mb-8">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input type="text" name="pengirim" placeholder="Tujuan Surat" value="{{ $item->tujuan }}" class="form-control" required>
                        <!--end::Input-->
                    </div>
                    <!--begin::Actions-->
                    <!--end::Input group-->
