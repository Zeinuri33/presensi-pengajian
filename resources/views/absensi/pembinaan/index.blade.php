    ...
    <div class="card-header align-items-center py-5 gap-2 gap-md-5" style="background-image: url('{{ asset('assets/media/ibrahimy/akses.png') }}'); background-size: cover; background-position: center; background-color: rgba(0,0,0,0.3); background-blend-mode: darken; color: white;">
        ...
        <div class="card-title">
            ...
            <div class="d-flex align-items-center position-relative my-1">
                ...
                <input type="text" data-kt-ecommerce-product-filter="search" class="form-control form-control-sm w-250px ps-12" placeholder="Cari Pembinaan" />
            </div>
            <!--end::Search-->
        </div>
        <!--end::Card title-->
        ...
        <table class="table align-middle table-striped fs-6 gy-4" id="kt_ecommerce_products_table">
            <thead class="fw-bold fs-5 bg-primary">
                <tr class="text-start text-white fw-bold fs-7 text-uppercase gs-0">
                    <th class="min-w-200px rounded-start ps-4">Tanggal Pembinaan</th>
                    <th>Umana'</th>
                    <th>Asrama</th>
                    <th></th>
                    <th></th>
            ...
            <tbody class="fw-semibold text-gray-600">
                ...
                <tr>
                    ...
                    <td></td>
                     <td>
                        <div class="badge py-3 px-4 fs-7 {{ $item->kepalakamar->jabatan == 'Kepala Kamar' ? 'badge-light-success' : 'badge-light-warning' }}">
                            {{ $item->kepalakamar->jabatan }}
                        </div>
                    </td>
                    <td></td>
                    <td class="text-end pe-4">
                        <a href="{{ route('hapus.pembinaan', $item->id) }}" class="btn btn-sm btn-danger hover-scale delete-button">Hapus</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
