...
<div class="modal fade" id="kt_modal_tambah" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-dialog modal-dialog-centered mw-600px">
        ...
        <div class="modal-body scroll-y px-15 px-lg-15 pt-0 pb-15">
            <!--begin:Form-->
            <form id="kt_modal_update_details" class="form" method="POST" enctype="multipart/form-data" action="/pengguna"">
                @csrf
                <!--begin::Heading-->
                ...
                <div class="fv-row mb-7">
                    ...
                    <!--end::Label-->
                    <!--begin::Input-->
                    <input type="text" name="name" class="form-control mb-3 mb-lg-0" placeholder="Nama Pengguna" required/>
                    <!--end::Input-->
                </div>
                <!--end::Input group-->
                <!--begin::Input group-->
                <div class="fv-row mb-7">
                    ...
                    <!--end::Label-->
                    <!--begin::Input-->
                    <input type="text" name="jabatan" class="form-control mb-3 mb-lg-0" placeholder="Jabatan Instansi" required/>
                    <!--end::Input-->
                </div>
                <!--end::Input group-->
                <!--begin::Input group-->
